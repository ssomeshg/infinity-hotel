 <!--==============================
			Footer Area
	==============================-->
  <footer class="footer-wrapper  footer-layout1" style="background: linear-gradient(45deg, #013630, #2e5398);">
                    ...
                    <div class="col-lg-4 col-md-6 mb-2">
                        <div class="media-style1">
                            ...
                            <div class="media-body">
                                ...
                                <p class="media-info"><a href="mailto:booking@innfinityandaman.com">booking@innfinityandaman.com</a> <br> <br></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mb-2">
                        <div class="media-style1">
                            ...
                            <div class="media-body">
                                ...
                                <p class="media-info">88 MA Road, Phongy Chang, Port Blair, Andaman & Nicobar Islands</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-xl-3 col-md-3">
                        <div class="widget widget_categories  footer-widget">
                            ...
                            <ul>
                                <li><a href="#">Rooms & Tariff
                                   </a></li>
                                <li><a href="#"> Introduction
                                   </a></li>
                                <li><a href="#"> Gallery
                                   </a></li>
                                <li><a href="#"> Tour Packages
                                   </a></li>
                                <li><a href="#">  Contact
                                   </a></li>
                            </ul>
	...
	******************************** -->
    ...
    ============================== -->
    <!-- Jquery -->
    <script src="<?php echo base_url() ?>assets/web/js/vendor/jquery-3.6.0.min.js"></script>
    <!-- Slick Slider -->
    ...
    <!-- Isotope Filter -->
    <script src="<?php echo base_url() ?>assets/web/js/imagesloaded.pkgd.min.js"></script>
