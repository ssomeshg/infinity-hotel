          ...
          <div class="card-body">
            ...
            <form action="<?php echo base_url(); ?>package/package_save" method="POST" enctype="multipart/form-data" id="formValidationExamples" class="row g-3 fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate">
              ...
              <div class="col-md-12 fv-plugins-icon-container">
                ...
                <textarea id="file-picker" name="package_content" class="form-control bootstrap-maxlength-example" rows="5"></textarea>
                <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
              </div>

              <div class="col-md-4 fv-plugins-icon-container">
                <label for="formValidationFile" name="image" class="form-label">Package Standard Cost</label>
                <input class="form-control" type="number" id="formValidationFile" name="standard_cost">
                <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
              </div>

              <div class="col-md-4 fv-plugins-icon-container">
                <label for="formValidationFile" name="image" class="form-label">Package Luxury Cost</label>
                <input class="form-control" type="number" id="formValidationFile" name="luxury_cost">
                <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
              </div>

              <div class="col-md-4 fv-plugins-icon-container">
                <label for="formValidationFile" name="image" class="form-label">Package Royal Cost</label>
                <input class="form-control" type="number" id="formValidationFile" name="royal_cost">
                <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
              </div>

              <div class="col-md-4 fv-plugins-icon-container">
                <label for="formValidationFile" name="image" class="form-label">Package Standard MRP Price</label>
                <input class="form-control" type="number" id="formValidationFile" name="standard_price">
                <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
              </div>

              <div class="col-md-4 fv-plugins-icon-container">
                <label for="formValidationFile" name="image" class="form-label">Package Luxury MRP Price</label>
                <input class="form-control" type="number" id="formValidationFile" name="luxury_price">
                <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
              </div>

              <div class="col-md-4 fv-plugins-icon-container">
                <label for="formValidationFile" name="image" class="form-label">Package Royal MRP Price</label>
                <input class="form-control" type="number" id="formValidationFile" name="royal_price">
                <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
              </div>
              <div class="col-md-4">
                <label class="form-label" for="bootstrap-maxlength-example2">Standard Description</label>
                <textarea id="file-picker" name="standard_description" class="form-control bootstrap-maxlength-example" rows="3"></textarea>
              </div>

              <div class="col-md-4">
                <label class="form-label" for="bootstrap-maxlength-example2">Luxury Description</label>
                <textarea id="file-picker" name="luxury_description" class="form-control bootstrap-maxlength-example" rows="3"></textarea>
              </div>

              <div class="col-md-4">
                <label class="form-label" for="bootstrap-maxlength-example2">Royal Description</label>
                <textarea id="file-picker" name="royal_description" class="form-control bootstrap-maxlength-example" rows="3"></textarea>
              </div>
              ...
              <div class="col-12">
                ...
                <textarea id="file-picker" name="package_inclusion" class="form-control bootstrap-maxlength-example" rows="5"></textarea>
              </div>
              ...
              <div class="col-12">
                ...
                <textarea id="file-picker" name="package_exclusions" class="form-control bootstrap-maxlength-example" rows="5"></textarea>
              </div>
